...
class TestMainPageQuestion:
    @allure.title('Проверка ответа на первый вопрос на главной странице')
    ...
    @allure.title('Проверка ответа на второй вопрос на главной странице')
    @allure.description('Проверяем, что ответ на вопрос виден пользователю и фактический текст совпадает с ожидаемым')
    ...
    @allure.title('Проверка ответа на третий вопрос на главной странице')
    @allure.description('Проверяем, что ответ на вопрос виден пользователю и фактический текст совпадает с ожидаемым')
    ...
    @allure.title('Проверка ответа на четвертый вопрос на главной странице')
    @allure.description('Проверяем, что ответ на вопрос виден пользователю и фактический текст совпадает с ожидаемым')
    ...
    @allure.title('Проверка ответа на пятый вопрос на главной странице')
    @allure.description('Проверяем, что ответ на вопрос виден пользователю и фактический текст совпадает с ожидаемым')
    ...
    @allure.title('Проверка ответа на шестой вопрос на главной странице')
    @allure.description('Проверяем, что ответ на вопрос виден пользователю и фактический текст совпадает с ожидаемым')
    ...
    @allure.title('Проверка ответа на седьмой вопрос на главной странице')
    @allure.description('Проверяем, что ответ на вопрос виден пользователю и фактический текст совпадает с ожидаемым')
    ...
    @allure.title('Проверка ответа на восьмой вопрос на главной странице')
    @allure.description('Проверяем, что ответ на вопрос виден пользователю и фактический текст совпадает с ожидаемым')
